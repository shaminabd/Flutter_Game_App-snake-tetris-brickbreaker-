                ...
                child: Center(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 20), // Add padding for spacing
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        // Return Button (Moved to the first position)
                        GestureDetector(
                          onTap: () {
                            Navigator.pop(
                  ...
                  SizedBox(
                    ...
                    child: GestureDetector(
                      ...
                      child: Card(
                          ...
                          child: Center(
                            child: Text(
                              isPlaying ? AppLocalizations.of(context).playing : AppLocalizations.of(context).play,
